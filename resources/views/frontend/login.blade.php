        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <html>
                    ...
                    <body>
                        <div class="inner">
                            <div class="image-holder" style="widht:50%; height:100%">
                                <img src="{{ asset('assets/login/images/furniture.jpg') }}">
                            </div>
                            <div class="image-holder" style="widht:50%;">
                                <form id="formlogin" style="width:auto;" method="post" action="{{ url('/customerlogin')}}">
                                    <div id="alertberhasil">
